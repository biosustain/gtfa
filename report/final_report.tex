...
With these definitions in place, $x$ can be split into two parts $x^{fi} \in \mathbb{R}^{ra}$ and $x^{fr}\in \mathbb{R}^{m+p-ra}$ that correspond to the basic and free variables of $S_m$.
...
In concrete terms, this means that the model proposes a set of free fluxes and this allows the determination of the rest of the fluxes such that they satisfy steady state.

% TODO: Continue here by defining the new model. Mention the challenge of the fixed exchange fluxes.

% TODO: Mention that S transforms fluxes to changes in met concentrations at the top

% TODO: ABOVE - need to define the transport reactions as well!
