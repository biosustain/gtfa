...
The solution is to combine estimates from both by projecting the $rc$ $\bsdgf$ estimate onto the range of $S$ and the $gc$ estimate onto the null space of $S^T$.
In the case of degenerate cofactor pairs, the null space of $S^T$ defines precisely their absolute formation energies, while the range of $S$ defines their relative formation energies.
