...
% TODO: Talk much more here about the different flux sampling methods up to this point

% Talk here about bayesian sampling method that allows for deviations from steady state to stop parameter fixing
% If they make these too tight they will have a problem - as they converge they include free variables
...
The Thermodynamics of of Enzyme-Catalysed Reactions Database (TECRDB) \cite{tecrdb} contains $\sdgr$ values for over 400 common metabolic reactions, which are determined experimentally by measuring substrate concentrations at equilibrium. %TODO: Number of reactions in TERCDB
...
% TODO: Check bayesian paper for their notation style as well
\begin{align*}
...
% TODO: Below should come at the end - We can define the constant scalar hyperparameters once the model is finished
...
% TODO: Move the below to the end.
...
% TODO: Relation between rank of S_m and S?
...
% TODO: New commands for the priors above
...
% TODO: Work on an example here (take one of the real samples) (look at how it changes over time)
The prior on concentrations is $\ln(c) ~ N(-8.34, 1.99)$ (as in \cite{PTA}), while the prior on exchange reactions is $v_\Pi ~ N(0, 1)$. % TODO: This needs to be changed
...
% TODO: Mention Lars' thing here? - K apparrent could be informative for us.
