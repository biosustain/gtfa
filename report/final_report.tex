...
The assumption behind the gc method is that metabolites can be broken down into counts of their constituent chemical moieties, as shown in Figure \ref{fig:gc}.
A linear regression on these counts is then performed to estimate the $\dgf$ of a compound of $\dgr$ of a reaction:
\begin{align}
    \bdgf_x =
\end{align}
