...
An alternative may be to have the effect of $\dgr$ on the flux saturate, which however unfortunately breaks the neat linear relationship between $\bv$ and $\log{\bc}$.
